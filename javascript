...
Initialize a Git repository, commit the project files, and push them to GitHub using appropriate Git commands.
...
o	Payload URL: http://<JENKINS_HOST>/github-webhook/ (Jenkins base URL + /github-webhook/)
...
$ kubectl get pods
NAME                                           READY   STATUS    RESTARTS   AGE
student-portal-deploy-66b8c6f5f9-abcde         1/1     Running   0          30s
...
spec:
  ...
  ports:
    - protocol: TCP
      port: 5000
      targetPort: 5000
      nodePort: 30080   # optional; if omitted, Kubernetes picks a port in 30000-32767
Apply service:
